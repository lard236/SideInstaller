...
while (!detached) {
    ...
    if (legacyCommands[brkImmediate] != undefined) {
        ...
        log(`Skipping breakpoint: brk immediate 0x${brkImmediate.toString(16)} was not handled by this script.`);
        continue;
    }
}
...
function JIT26HandleBrk0x69(brkResponse) {
    log(`Error: It seems you are using legacy breakpoint 0x69.`);
